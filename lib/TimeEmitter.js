...
class TimeEmitter extends events.EventEmitter {
  constructor() {
    ...
    this.isSixHours = () => (this.isHour() ? (this.clock.getHours() % 6 === 0) : false);
    this.isMidnight = () => (this.isSixHours() ? (this.clock.getHours() === 0) : false);
    this.isWeek = () => (this.isMidnight() ? (this.clock.getDay() === 0) : false);
    this.isMonth = () => (this.isMidnight() ? (this.clock.getDate() === 1) : false);
    this.isYear = () => (this.isMonth() ? (this.clock.getMonth() === 0) : false);
  }
